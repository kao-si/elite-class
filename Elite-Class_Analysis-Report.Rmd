...
mod_rural_s <- list(
  "CEE Total Score_Rural" = rural_s1,
  "CEE Total Score_Urban" = urban_s1,
  "Average High School Performance_Rural" = rural_s2,
  "Average High School Performance_Urban" = urban_s2
)
...
mod_rural_l <- list(
  "CEE Total Score_Rural" = rural_l1,
  "CEE Total Score_Urban" = urban_l1,
  "Average High School Performance_Rural" = rural_l2,
  "Average High School Performance_Urban" = urban_l2
)
...
mod_jhschrural_s <- list(
  "CEE Total Score_Rural" = jhschrural_s1,
  "CEE Total Score_Urban" = jhschurban_s1,
  "Average High School Performance_Rural" = jhschrural_s2,
  "Average High School Performance_Urban" = jhschurban_s2
)
...
mod_jhschrural_l <- list(
  "CEE Total Score_Rural" = jhschrural_l1,
  "CEE Total Score_Urban" = jhschurban_l1,
  "Average High School Performance_Rural" = jhschrural_l2,
  "Average High School Performance_Urban" = jhschurban_l2
)
...
mod_fjob_s <- list(
  "CEE Total Score_Low Status Jobs" = fjob_low_s1,
  "CEE Total Score_High Status Jobs" = fjob_high_s1,
  "Average High School Performance_Low Status Jobs" = fjob_low_s2,
  "Average High School Performance_High Status Jobs" = fjob_high_s2
)
...
mod_fjob_l <- list(
  "CEE Total Score_Low Status Jobs" = fjob_low_l1,
  "CEE Total Score_High Status Jobs" = fjob_high_l1,
  "Average High School Performance_Low Status Jobs" = fjob_low_l2,
  "Average High School Performance_High Status Jobs" = fjob_high_l2
)
...
mod_mjob_s <- list(
  "CEE Total Score_Low Status Jobs" = mjob_low_s1,
  "CEE Total Score_High Status Jobs" = mjob_high_s1,
  "Average High School Performance_Low Status Jobs" = mjob_low_s2,
  "Average High School Performance_High Status Jobs" = mjob_high_s2
)
...
mod_mjob_l <- list(
  "CEE Total Score_Low Status Jobs" = mjob_low_l1,
  "CEE Total Score_High Status Jobs" = mjob_high_l1,
  "Average High School Performance_Low Status Jobs" = mjob_low_l2,
  "Average High School Performance_High Status Jobs" = mjob_high_l2
)
...
mod_pjob_s <- list(
  "CEE Total Score_Neither High Status" = pjob_neither_s1,
  "CEE Total Score_One High Status"      = pjob_one_s1,
  "CEE Total Score_Both High Status"   = pjob_both_s1,
  "Average High School Performance_Neither High Status" = pjob_neither_s2,
  "Average High School Performance_One High Status"      = pjob_one_s2,
  "Average High School Performance_Both High Status"   = pjob_both_s2
)
...
mod_pjob_l <- list(
  "CEE Total Score_Neither High Status" = pjob_neither_l1,
  "CEE Total Score_One High Status"      = pjob_one_l1,
  "CEE Total Score_Both High Status"   = pjob_both_l1,
  "Average High School Performance_Neither High Status" = pjob_neither_l2,
  "Average High School Performance_One High Status"      = pjob_one_l2,
  "Average High School Performance_Both High Status"   = pjob_both_l2
)
