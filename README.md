...
| cls_elite               | Elite Class Indicator                            | Regular Class; Elite Class                                   | NA for untreated cohorts                                     |
| top_scorer              | Top Scorers in HSEE                              | No; Yes                                                      | See "Cutoff Points for "Top Scorers"" section                |
| elite                   | Student Category Indicator                       | Regular Students; Elite Students; Regular Class Top Scorers; Elite Class Non-Top Scorers | Categories removed for majority of analyses: Regular Class Top Scorers; Elite Class Non-Top Scorers; these two categories are only present in the treated cohorts |
| top_regular             | Top Scorers in HSEE among "Regular Students"     | No; Yes                                                      |                                                              |
...
| **hsee_ctot**           | HSEE Total Scores Centered around the Cutoffs    |                                                              | Center total score of hsee (untrimmed) around the cutoffs for top scorers; center tot at cutoffs then divided by standard deviation, equivalent to centering ztot at cutoffs; only apply to Science Track of Cohorts 2003-2007 and Liberal Arts Track of Cohorts 2005-2007 (same for hsee_ctot2) |
| hsee_ctot2              | HSEE Total Scores Centered around the Cutoffs    |                                                              | Center total score of hsee (untrimmed) around the cutoffs for top scorers; center tot at cutoffs then divided by root mean square |
| f_job_l2                | Father Job Category                              | Low Status Job; High Status Job                              | Low status: levels 1-3; High status: level 4-6               |
| m_job_l2                | Mother Job Category                              | Low Status Job; High Status Job                              | Low status: levels 1-3; High status: level 4-6               |
| par_job                 | Combined Parents Job Category                    | Neither Parent in High Status Jobs; One Parent in High Status Job; Both Parents in High Status Jobs |                                                              |
| top_cat                 | Indicator for Two Categories of Students         | Elites Students; Top Regular Students                        |                                                              |
| hsee_decile             | Indicator for Subgroup Based on HSEE Total Score |                                                              | Decile (10%-bin) groups for HSEE total score within cohort-track-top_cat |
| hsee_2decile            | Indicator for Subgroup Based on HSEE Total Score |                                                              | 2-decile (20%-bin) groups for HSEE total score within cohort-track-top_cat |
| hsee_5decile            | Indicator for Subgroup Based on HSEE Total Score |                                                              | 5-decile (50%-bin) groups for HSEE total score within cohort-track-top_cat |
